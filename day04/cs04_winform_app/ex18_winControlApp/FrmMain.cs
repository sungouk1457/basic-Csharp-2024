...
namespace ex18_winControlApp
{
    ...
    {
        Random rand = new Random(); // 트리뷰 노드이름으로 사용할 랜던값
        public FrmMain()
        {
            ...
            //GrbEditor.Text = "텍스터에디터"; // 코드비하인드 디자인셋팅
        }
        ...
        void changeFont()
        {
            ...
            FontStyle style = FontStyle.Regular; //일반글자(볼드X, 이탤릭X)
        ...
        {
            PrgDummy.Value = TrbDummy.Value; //트랙바 포인터를 옮기면 프로그래스바 값도 같이 변경
        }
        ...
        private void BtnFileLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                //UTF-8아 한글이 깨짐. EUC-KR(Window 949), UTF-8(BOM)은 한글이 문제 없음
        ...
        private void DoRealWork(BackgroundWorker worker, DoWorkEventArgs e)
        {
            ...
            for(var i = 0;i <= maxValue;i++)
            {
                ...
                else
                {
                    ...
                    // 아래를 실행하면, BgwProgress_ProcessChaged 이벤트핸들러의
